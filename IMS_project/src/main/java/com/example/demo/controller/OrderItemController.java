...
public class OrderItemController {
   ...
   public List<OrderItem> show()
   {
	...
	@PutMapping("oiupdatebyid/{orderitemid}")
	public String modifybyid(@PathVariable int orderitemid,@RequestBody OrderItem oi)
	{
		return o.updateinfobyid(orderitemid, oi);
	}
